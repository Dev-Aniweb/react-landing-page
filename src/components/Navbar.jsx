...
const Navbar = () => {
  ...
  return (
    <nav className=' sticky top-0 z-50 py-3 backdrop-blur-lg borader-b border-neutral-700/80'>
    ...
    <div className="container px-4 mx-auto relative text-sm">
       ...
       <div className="flex justify-between item-center">
        ...
        <div className='hidden lg:flex justify-center space-x-12 items-center'>
            ...
            <a href='#' className=' `bg-gradient-to-r` from-orange-500 to-orange-800 py-2 px-3'>Create an Account</a>
